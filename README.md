...
```
  Dev machine (this repo)                    Mac mini  192.168.50.176
  ─────────────────────────                  ──────────────────────────
...
`mac-mini.tailde4b5e.ts.net` (`100.93.41.48`), sleep is disabled, and both Postgres and
...
```ini
DATABASE_URL=postgresql+psycopg://alex:<password>@192.168.50.176:55432/alex

LLM_PROVIDER=local
LOCAL_BASE_URL=http://192.168.50.176:11434/v1
